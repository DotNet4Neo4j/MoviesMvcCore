...
public class MovieDriverOgmController : Controller
{
    ...
    public async Task<ActionResult<IEnumerable<Movie>>> List()
    {
        ...
        var queryResults = await _driver.ExecutableQuery(query)
            .WithConfig(new QueryConfig(RoutingControl.Readers))
            .ExecuteAsync();
        ...
        //     {
        //         // Get the 'Node'
        //         var movie = cursor.Current.AsObject<Movie>();
        //         // Add to our output
        //         output.Add(movie);
        //         // Do we have more?
    ...
    // /// </summary>
    // /// <remarks>
    // ///     From a development point of view, this saves us writing it 10 times for 10 methods - but, it might be a bit clunky
    // ///     to do this
    // ///     for every object we want to convert to. I would advise you to look at <see cref="MovieExtensionController" /> or
    // ///     <see cref="MovieNeo4jClientController" />
    // ///     for alternatives.
    // /// </remarks>
